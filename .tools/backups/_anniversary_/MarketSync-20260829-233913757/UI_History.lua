...
function MarketSync.CreateItemHistoryPanel(parentFrame)
    ...
    -- Sync label (bottom left)
    panel.syncLabel = panel:CreateFontString(nil, "OVERLAY", "GameFontNormalSmall")
    panel.syncLabel:SetPoint("BOTTOMLEFT", parentFrame, "BOTTOMLEFT", 30, 20)
    ...
    panel.itemCountText:SetPoint("BOTTOMLEFT", parentFrame, "BOTTOMLEFT", 350, 20)
    ...
    panel.scanPageText:SetPoint("BOTTOMLEFT", parentFrame, "BOTTOMLEFT", 440, 20)
