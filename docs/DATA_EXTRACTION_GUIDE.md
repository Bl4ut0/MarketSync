...
In World of Warcraft, an active Auction House catalog with 2,000 to 30,000+ item variants and price history reaches **1.5 MB – 12 MB** of structured Lua data (75,000 to 250,000+ lines in `SavedVariables/MarketSync.lua`). 
